...
extern "C" {
    ...
    //lly =============================================
    JNIEXPORT void JNICALL Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeDiscardFrames(JNIEnv* env, , jobject thiz, jint frames) {
        cocos2d::Director::getInstance()->discardFrames(frames);
    }
    //=================================================
